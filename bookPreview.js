...
export class BookPreview extends HTMLElement {
  ...
  //method called when element gets inserted into DOM
  connectedCallback() {
    //fetches attributes of custom element
    ...
    //set content of custom element
    //add style section for good practice
    this.innerHTML = `
            <style>
                    :host {
                        margin: 0;
...
//define class as a custom HTML element
